...
## [0.40.0](https://github.com/BagelLab/uds-core/compare/v0.39.0...v0.40.0) (2025-04-09)


### ⚠ BREAKING CHANGES

* only allow creation of one `UDSPackage` per namespace ([#1372](https://github.com/BagelLab/uds-core/issues/1372))
* make istio ambient components default in uds core ([#1428](https://github.com/BagelLab/uds-core/issues/1428))
* move disable registration fields to theme values ([#1397](https://github.com/BagelLab/uds-core/issues/1397))
...
* only allow creation of one `UDSPackage` per namespace ([#1372](https://github.com/BagelLab/uds-core/issues/1372)) ([2f4dbac](https://github.com/BagelLab/uds-core/commit/2f4dbac60ee17afe07a4ce62f96285a0e0f04e47))
...
* **deps:** update grafana to v8.10.4 ([#1363](https://github.com/BagelLab/uds-core/issues/1363)) ([fb163bd](https://github.com/BagelLab/uds-core/commit/fb163bdf69b6b8a3d5d251a9e52bd512cc3e394e))
...
* **deps:** update keycloak to v26.1.4 ([#1356](https://github.com/BagelLab/uds-core/issues/1356)) ([31152f7](https://github.com/BagelLab/uds-core/commit/31152f7659ef02335494d3a3646b49a4dd68398d))
...
* **deps:** update prometheus-stack ([#1380](https://github.com/BagelLab/uds-core/issues/1380)) ([eec3337](https://github.com/BagelLab/uds-core/commit/eec3337a61992a2eb50af54471c96f5d5d9c001e))
...
* **deps:** update support dependencies to v3.28.14 ([#1435](https://github.com/BagelLab/uds-core/issues/1435)) ([d29d1b5](https://github.com/BagelLab/uds-core/commit/d29d1b5abfe484747631b53b7475af83fa7946d0))
...
* **deps:** update velero ([#1299](https://github.com/BagelLab/uds-core/issues/1299)) ([59ce747](https://github.com/BagelLab/uds-core/commit/59ce747ddef860911403260c39ba1ae1ed29fbdf))
...
* **deps:** update velero to v8.6.0 ([#1371](https://github.com/BagelLab/uds-core/issues/1371)) ([93a44e6](https://github.com/BagelLab/uds-core/commit/93a44e6d67b36f92c204d043484d996e877194ac))
* **deps:** update velero to v8.7.1 ([#1391](https://github.com/BagelLab/uds-core/issues/1391)) ([ea4ed0f](https://github.com/BagelLab/uds-core/commit/ea4ed0fe7aa2282ed6aeec397432f14790461cb9))
...
* **docs:** fix order of authpols doc ([#1408](https://github.com/BagelLab/uds-core/issues/1408)) ([ee55ab1](https://github.com/BagelLab/uds-core/commit/ee55ab10091f1ef150bc1050b19ca8ec494deaa8))
* **docs:** keycloak session timeout doc ([#1315](https://github.com/BagelLab/uds-core/issues/1315)) ([9509ac7](https://github.com/BagelLab/uds-core/commit/9509ac7119181056314cd956fc8db192a7fb819d))
...
* enable ambient component for rke2/aks ci ([#1322](https://github.com/BagelLab/uds-core/issues/1322)) ([c280b03](https://github.com/BagelLab/uds-core/commit/c280b03fa9153b0345d00e74c2385e57db21df57))
...
* **main:** release 0.37.0 ([#1312](https://github.com/BagelLab/uds-core/issues/1312)) ([4aac12e](https://github.com/BagelLab/uds-core/commit/4aac12ed3e7ed03774e28bcbd8e89107709d56ea))
* **main:** release 0.38.0 ([#1338](https://github.com/BagelLab/uds-core/issues/1338)) ([a3fdcbc](https://github.com/BagelLab/uds-core/commit/a3fdcbce0d6e4bf1110bee8567b3ef58e90a0b8e))
* **main:** release 0.39.0 ([#1373](https://github.com/BagelLab/uds-core/issues/1373)) ([0fa1587](https://github.com/BagelLab/uds-core/commit/0fa15878051e4e0cd0be2becf9f99d8fa8249299))
...
* prefer `===` for comparisons ([#1412](https://github.com/BagelLab/uds-core/issues/1412)) ([6963633](https://github.com/BagelLab/uds-core/commit/696363385bfc569c79688364ad16d03aae852117))
...
* remove kiali and tempo references from repo ([#1375](https://github.com/BagelLab/uds-core/issues/1375)) ([8374de3](https://github.com/BagelLab/uds-core/commit/8374de3cbfccfffd6825ae59c18e6080f691346b))
...
* switch to azure gov account ([#1318](https://github.com/BagelLab/uds-core/issues/1318)) ([31ec997](https://github.com/BagelLab/uds-core/commit/31ec997156305db90538169093a77bcf69e64a89))
...
* update changelog ([#1406](https://github.com/BagelLab/uds-core/issues/1406)) ([4239d95](https://github.com/BagelLab/uds-core/commit/4239d958744408d47c93021d4d5937b426d36db9))
...
* update how to scrape metrics ([#1378](https://github.com/BagelLab/uds-core/issues/1378)) ([e808f7d](https://github.com/BagelLab/uds-core/commit/e808f7d394ea4848c6203cc469960f82b89d0fa4))
...
* update unicorn ztunnel image to 1.25.0 ([#1389](https://github.com/BagelLab/uds-core/issues/1389)) ([7e446cb](https://github.com/BagelLab/uds-core/commit/7e446cbff939d144f964d41c55190626075f410a))
...
* add developer doc on ci testing ([#1344](https://github.com/BagelLab/uds-core/issues/1344)) ([0e011a4](https://github.com/BagelLab/uds-core/commit/0e011a4915101f6dbc74b3c3e2ba27bd2fc57364))
...
* velero csi vsphere backups ([#1385](https://github.com/BagelLab/uds-core/issues/1385)) ([5ae33b2](https://github.com/BagelLab/uds-core/commit/5ae33b2d01f308f5d7d067d30aa4b911d1c0d20e))
